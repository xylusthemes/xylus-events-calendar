<?php
function easy_events_calendar_gutenberg_shortcode( $atts ) {
    ...
    if ( isset( $xylusec_events_calendar ) && isset( $xylusec_events_calendar->common ) ) {
        $events_query = $xylusec_events_calendar->common->xylusec_get_upcoming_events( $selected_post_type, 1, '', $limit,  $category_json );
    } else {
...
add_shortcode( 'easy_events_calendar_gutenberg', 'easy_events_calendar_gutenberg_shortcode' );