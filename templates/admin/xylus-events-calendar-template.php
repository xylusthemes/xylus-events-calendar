...
<div id="xylusec-calendar-container">
    ...
    <div id="xylusec-grid-view-container" class="custom-grid-view" style="display: none;">
        ...
        <div class="xylusec-no-events" style="display: none;padding:15px;text-align:center;color:<?php echo esc_attr( $xylusec_title_color ); ?>;border:1px solid <?php echo esc_attr( $xylusec_arrowbg_color ); ?>;border-radius:5px;margin-top:15px;">
        ...
        <div class="xylusec-inner-main-container">
            ...
            <style>
                .xylusec-slider-arrow {
                    background: <?php echo esc_attr( $xylusec_arrowbg_color ); ?>;
                    color: <?php echo esc_attr( $xylusec_text_color ); ?>;
                }
            </style>
        </div>
        <div class="xylusec-no-events" style="display: none;padding:15px;text-align:center;color:<?php echo esc_attr( $xylusec_title_color ); ?>;border:1px solid <?php echo esc_attr( $xylusec_arrowbg_color ); ?>;border-radius:5px;margin-top:15px;">
