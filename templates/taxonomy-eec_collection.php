<?php
/**
 * Taxonomy archive template for Event Collections (eec_collection).
 *
 * Displays events filtered by a specific event collection.
 *
 * Override: Copy to {theme}/xylus-events-calendar/taxonomy-eec_collection.php
 *
...
<div class="eec-archive-wrap">
	...
	<div class="eec-archive-header">
		<div class="eec-taxonomy-badge"><?php esc_html_e( 'Collection', 'xylus-events-calendar' ); ?></div><br>
	...
	<div class="eec-ajax-results-container" style="position: relative; min-height: 200px;">
		...
		<div id="eec-events-grid" data-taxonomy="eec_collection" data-term="<?php echo esc_attr( $term->slug ); ?>">
			<?php 
