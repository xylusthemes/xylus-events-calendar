<?php
/**
 * Taxonomy archive template for Event Categories (eec_category).
 *
 * Displays events filtered by a specific event category.
 *
 * Override: Copy to {theme}/xylus-events-calendar/taxonomy-eec_category.php
 *
...
<div class="eec-archive-wrap">
	...
	<div class="eec-archive-header">
		<div class="eec-taxonomy-badge"><?php esc_html_e( 'Category', 'xylus-events-calendar' ); ?></div><br>
	...
	// Filters are available on the root /eec-category/ page.
	?>
	...
	<div class="eec-ajax-results-container" style="position: relative; min-height: 200px;">
		...
		<div id="eec-events-grid" data-taxonomy="eec_category" data-term="<?php echo esc_attr( $term->slug ); ?>">
			<?php 
